  ...
  if (show) {
    return (
      <DateTimePicker
        ...
        style={{ width: 320, backgroundColor: "black" }} //add this
      />
    );
  }
  return (
    ...
    >
      ...
      >
        <AntDesign name="closecircleo" size={30} color="grey" />
      </TouchableOpacity>
      <View style={[styles.model, { backgroundColor: "white" }]}>
        <View
          style={{
            flexDirection: "row",
            alignItems: "center",
        ...
        >
          ...
          <View style={{ flexDirection: "column" }}>
            <Text
              style={[
                styles.text,
                { fontSize: 10, alignSelf: "center", color: "black" },
              ]}
            >
              Tap to change
            </Text>
